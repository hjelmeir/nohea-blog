...
function optionsframework_load_styles() {
	wp_enqueue_style('optionsframework', OPTIONS_FRAMEWORK_DIRECTORY.'css/admin-style.css');
...
function patus() {
	echo '';
	echo '<div id="patus">UXDE dot Net <a href="http://www.uxde.net/">Wordpress Themes</a></div>';
	echo '';
}