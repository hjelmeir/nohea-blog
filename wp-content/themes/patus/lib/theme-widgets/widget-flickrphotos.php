...
function ux_load_flickr_widget()
{
	register_widget( 'UXDE_flickr' );
}

add_action('widgets_init', 'ux_load_flickr_widget');

class UXDE_Flickr extends WP_Widget {

	function UXDE_Flickr(){
		$widget_ops = array( 'classname' => 'UXDE_Flickr', 'description' => __('Show off some of your latest Flickr photos', 'uxde') );
		$this->WP_Widget( 'uxde_flickr', 'Flickr Stream', $widget_ops);
	}
...
<?php
	...
	function form($instance) {
		$default_flickr=stripslashes(get_option('uxde_flickr_id'));
